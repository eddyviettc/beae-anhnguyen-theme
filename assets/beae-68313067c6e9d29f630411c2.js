(() => { if (window.BEAEPAGEJS === undefined) {
          ...
          window.beaePageSetting.pageId = "68313067c6e9d29f630411c2";
              window.beaePageSetting.pageTitle = "test123123"; 
              window.beaePageSetting.pageType = "product";

          let js_36M3503J = () => { let BeaeUseHooks = {};
      try {
        let argid = 'beae-kz5m0h5qsection-js',
        ...
        args.els = document.querySelectorAll('.beae-kz5m0h5q');
        args.el = args.els[0];
        ...
        console.error('BEAE JS ERROR ID beae-kz5m0h5q: ', ex)
      };
    

      try {
        let argid = 'beae-1bd0avjisection-featured-product',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-1bd0avji',
      ...
      try {
        ...
        args.els = document.querySelectorAll('.beae-4yspvlyb');
        args.el = args.els[0];
      ...
      try {
        let argid = 'beae-xlhut13iblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-xlhut13i',
        ...
        args.els = document.querySelectorAll('.beae-xlhut13i');
        args.el = args.els[0];
        ...
        console.error('BEAE JS ERROR ID beae-xlhut13i: ', ex)
      };
    

      try {
        let argid = 'beae-4zskogjhblock-buy',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-4zskogjh',
        ...
        args.els = document.querySelectorAll('.beae-4zskogjh');
        args.el = args.els[0];
        ((d) => { d.els&&d.els.forEach(l=>{const v=l.querySelector('.beae-quantity-btn[name="plus"]'),y=l.querySelector('.beae-quantity-btn[name="minus"]'),b=l.querySelector(".beae-quantity-input");v&&y&&b&&(b.value===""&&(b.value="1"),v.addEventListener("click",function(){v.getAttribute("disabled")!="disabled"&&b.stepUp()}),y.addEventListener("click",function(){y.getAttribute("disabled")!="disabled"&&b.stepDown()}))}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-4zskogjh: ', ex)
      };
    

      try {
        let argid = 'beae-hefdg0fnblock-add-to-cart',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-hefdg0fn',
        ...
        args.els = document.querySelectorAll('.beae-hefdg0fn');
        args.el = args.els[0];
        ((_) => { if(_.mode.value=="builder"){if(!_.els)return;for(let C=0;C<_.els.length;C++)if(C==_.loopIndex){const S=_.els[C].closest("form.beae-product-form-next");if(!S)return;const $=S.querySelector(".beae-add-to-cart--submit"),B=S.getAttribute("data-product_id"),k=S.querySelector('script[data-id="Product-json-'+B+'"]')||S.querySelector("#Product-json-"+B),M=JSON.parse(k!=null&&k.innerHTML?k==null?void 0:k.innerHTML:"{}").variants||[];let L=S.getAttribute("data-variant-id"),V=M[0];L&&(V=M.find(N=>N.id==L));const T=$.querySelector(".beae-add-to-cart-text-content");V!=null&&V.available?T&&(M.length>1?T.innerHTML=$.getAttribute("data-choose-options-text"):T.innerHTML=$.getAttribute("data-add-to-cart-text")):T&&(T.innerHTML=$.getAttribute("data-sold-out-text"))}} })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-hefdg0fn: ', ex)
      };
    

      try {
        let argid = 'beae-sqhexy81',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-sqhexy81',
        ...
        args.els = document.querySelectorAll('.beae-sqhexy81');
        args.el = args.els[0];
        (($) => { setTimeout(()=>{const B=$.el.querySelector(".shopify-payment-button__button","");B&&B.classList.add($.buyItNowType)},1e3) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-sqhexy81: ', ex)
      };
    

      try {
        let argid = 'beae-6t36s607section-slide-show',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-6t36s607',
        ...
        args.els = document.querySelectorAll('.beae-6t36s607');
        args.el = args.els[0];
        ((h) => { window.BeaeSlider&&!h.noRunJs&&window.BeaeSlider(h) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-6t36s607: ', ex)
      };
    

      try {
        let argid = 'beae-kbvt2ulmblock-textloop-0',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-kbvt2ulm',
        ...
        args.els = document.querySelectorAll('.beae-kbvt2ulm');
        args.el = args.els[0];
        ((P) => { P.el.querySelectorAll(".beae-x-text a").forEach(I=>{let z=I==null?void 0:I.getAttribute("href");I&&P.mode.value!=="builder"&&(z!=null&&z.includes("#"))&&I.addEventListener("click",O=>{let A=document.querySelector(z+","+(z==null?void 0:z.replace("#",".")));if(A)return A.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),O.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-kbvt2ulm: ', ex)
      };
    

      try {
        let argid = 'beae-kbvt2ulmblock-textloop-1',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-kbvt2ulm',
      ...
      try {
        let argid = 'beae-kbvt2ulmblock-textloop-2',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-kbvt2ulm',
      ...
      try {
        let argid = 'beae-kbvt2ulmblock-textloop-3',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-kbvt2ulm',
      ...
      try {
        let argid = 'beae-kbvt2ulmblock-textloop-4',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-kbvt2ulm',
      ...
      try {
        let argid = 'beae-kns3aqz9block-tabs',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-kns3aqz9',
        ...
        args.els = document.querySelectorAll('.beae-kns3aqz9');
        args.el = args.els[0];
      ...
      try {
        ...
        args.els = document.querySelectorAll('.beae-m309b4rw');
        args.el = args.els[0];
        ((P) => { P.el.querySelectorAll(".beae-x-text a").forEach(I=>{let z=I==null?void 0:I.getAttribute("href");I&&P.mode.value!=="builder"&&(z!=null&&z.includes("#"))&&I.addEventListener("click",O=>{let A=document.querySelector(z+","+(z==null?void 0:z.replace("#",".")));if(A)return A.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),O.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-m309b4rw: ', ex)
      };
    

      try {
        let argid = 'beae-h8ynjrjnblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-h8ynjrjn',
        ...
        args.els = document.querySelectorAll('.beae-h8ynjrjn');
        args.el = args.els[0];
        ((P) => { P.el.querySelectorAll(".beae-x-text a").forEach(I=>{let z=I==null?void 0:I.getAttribute("href");I&&P.mode.value!=="builder"&&(z!=null&&z.includes("#"))&&I.addEventListener("click",O=>{let A=document.querySelector(z+","+(z==null?void 0:z.replace("#",".")));if(A)return A.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),O.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-h8ynjrjn: ', ex)
      };
    

      try {
        let argid = 'beae-dc66d8j6block-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-dc66d8j6',
        ...
        args.els = document.querySelectorAll('.beae-dc66d8j6');
        args.el = args.els[0];
        ((P) => { P.el.querySelectorAll(".beae-x-text a").forEach(I=>{let z=I==null?void 0:I.getAttribute("href");I&&P.mode.value!=="builder"&&(z!=null&&z.includes("#"))&&I.addEventListener("click",O=>{let A=document.querySelector(z+","+(z==null?void 0:z.replace("#",".")));if(A)return A.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),O.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-dc66d8j6: ', ex)
      };
    

      try {
        let argid = 'beae-7xq1xg0oblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-7xq1xg0o',
        ...
        args.els = document.querySelectorAll('.beae-7xq1xg0o');
        args.el = args.els[0];
        ((P) => { P.el.querySelectorAll(".beae-x-text a").forEach(I=>{let z=I==null?void 0:I.getAttribute("href");I&&P.mode.value!=="builder"&&(z!=null&&z.includes("#"))&&I.addEventListener("click",O=>{let A=document.querySelector(z+","+(z==null?void 0:z.replace("#",".")));if(A)return A.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),O.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-7xq1xg0o: ', ex)
      };
    

      try {
        let argid = 'beae-8d8q8c1fblock-share',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-8d8q8c1f',
        ...
        args.els = document.querySelectorAll('.beae-8d8q8c1f');
        args.el = args.els[0];
        ((l) => { const v=window.location.href;if(l.type=="label_with_icon"){if(l.mode.value=="live"){let b=function(p){switch(p){case"facebook":return"https://www.facebook.com/sharer/sharer.php?u=";case"twitter":return"https://twitter.com/intent/tweet?url=";case"linkedIn":return"https://www.linkedin.com/shareArticle?mini=true&url=";case"pinterest":return"https://pinterest.com/pin/create/button/?url=";case"reddit":return"https://reddit.com/submit?url=";case"skype":return"https://web.skype.com/share?url=";case"telegram":return"https://t.me/share/url?url=";case"whatsApp":return"https://api.whatsapp.com/send/?phone&text=";case"email":return"mailto:?&subject=&cc=&bcc=&body=";default:return"#"}};const h=l.el.querySelectorAll(".beae-share-link");h.length>0&&h.forEach((p,f)=>{let m=p.getAttribute("type"),w="";w=b(m)+v,p.setAttribute("href",w)})}}else if(l.type=="copy_link"){const b=l.el.querySelector(".beae-share-wrp");b.onclick=()=>{window.navigator.clipboard.writeText(v),y()}}else{const b=l.el.querySelector(".beae-share-wrp"),h=l.el.querySelector(".beae-share-link-copy-link");if(h&&(h.innerHTML=v),navigator.share)b.addEventListener("click",()=>{navigator.share({url:v,title:document.title})});else{const p=l.el.querySelector(".beae-share--container");l.el.querySelector(".beae-share-link-copy-btn").addEventListener("click",()=>{window.navigator.clipboard.writeText(v),y(),p.classList.remove("active")}),b.addEventListener("click",()=>{p.classList.toggle("active")}),document.addEventListener("click",function(m){p.contains(m.target)||p.classList.remove("active")})}}function y(){const b=l.el.querySelector(".beae-share--toast");b&&(b.classList.add("active"),setTimeout(()=>{b.classList.remove("active")},1e3))} })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-8d8q8c1f: ', ex)
      };
    

      try {
        let argid = 'beae-xoqqnh2asection-js',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-xoqqnh2a',
        ...
        args.els = document.querySelectorAll('.beae-xoqqnh2a');
        args.el = args.els[0];
        ((t) => { var o;if((o=t.el.querySelector(".beae-grid-system"))==null||o.addEventListener("scroll",a=>{var r,l;let n=a.target;if(!n.classList.contains("beae-grid-carousel"))return;let s=Math.round((n.scrollLeft+n.querySelector(".beae-grid-carousel__snaps").offsetLeft)/(n.offsetWidth*.8))+1;(r=t.el.querySelector(".beae-grid-carousel__pagination div.active"))==null||r.classList.remove("active"),(l=t.el.querySelector('.beae-grid-carousel__pagination div[data-index="'+s+'"]'))==null||l.classList.add("active")}),t.mode.value=="live"){const a=t.el.querySelector('.beae-section-background-video[data-device="desktop"]'),n=t.el.querySelector('.beae-section-background-video[data-device="mobile"]'),s=[];window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection&&(window.innerWidth>=768?a&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a)&&s.push("desktop"):n&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n)&&s.push("mobile")),(a||n)&&window.addEventListener("resize",()=>{if(window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection){if(!s.includes("desktop")&&window.innerWidth>=768&&a){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a);r&&(a.innerHTML=r.html,s.push("desktop"))}if(!s.includes("mobile")&&window.innerWidth<768&&n){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n);r&&(n.innerHTML=r.html,s.push("mobile"))}}})}t.el.querySelectorAll(".beae-text-highlight").forEach(a=>{new IntersectionObserver((s,r)=>{s.forEach(l=>{l.isIntersecting&&(l.target.querySelectorAll("path, line").forEach(c=>{c.style.strokeDasharray=parseFloat(c.getAttribute("data-dash-ratio")*l.target.offsetWidth*2)+"px, 999999px"}),r.unobserve(l.target))})},{root:document,rootMargin:"0px 0px -40%"}).observe(a)}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-xoqqnh2a: ', ex)
      };
    

      try {
        let argid = 'beae-5jho98dfblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-5jho98df',
        ...
        args.els = document.querySelectorAll('.beae-5jho98df');
        args.el = args.els[0];
        ((P) => { P.el.querySelectorAll(".beae-x-text a").forEach(I=>{let z=I==null?void 0:I.getAttribute("href");I&&P.mode.value!=="builder"&&(z!=null&&z.includes("#"))&&I.addEventListener("click",O=>{let A=document.querySelector(z+","+(z==null?void 0:z.replace("#",".")));if(A)return A.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),O.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-5jho98df: ', ex)
      };
    

      try {
        let argid = 'beae-iyv00nxbblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-iyv00nxb',
        ...
        args.els = document.querySelectorAll('.beae-iyv00nxb');
        args.el = args.els[0];
        ((P) => { P.el.querySelectorAll(".beae-x-text a").forEach(I=>{let z=I==null?void 0:I.getAttribute("href");I&&P.mode.value!=="builder"&&(z!=null&&z.includes("#"))&&I.addEventListener("click",O=>{let A=document.querySelector(z+","+(z==null?void 0:z.replace("#",".")));if(A)return A.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),O.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-iyv00nxb: ', ex)
      };
    

      try {
        let argid = 'beae-wbeyywq0section-featured-collection',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-wbeyywq0',
      ...
      try {
        let argid = 'beae-h3nc6lrhblock-image',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-h3nc6lrh',
        ...
        args.els = document.querySelectorAll('.beae-h3nc6lrh');
        args.el = args.els[0];
        ...
        console.error('BEAE JS ERROR ID beae-h3nc6lrh: ', ex)
      };
    

      try {
        let argid = 'beae-eh51fxe0block-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-eh51fxe0',
        ...
        args.els = document.querySelectorAll('.beae-eh51fxe0');
        args.el = args.els[0];
        ((P) => { P.el.querySelectorAll(".beae-x-text a").forEach(I=>{let z=I==null?void 0:I.getAttribute("href");I&&P.mode.value!=="builder"&&(z!=null&&z.includes("#"))&&I.addEventListener("click",O=>{let A=document.querySelector(z+","+(z==null?void 0:z.replace("#",".")));if(A)return A.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),O.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-eh51fxe0: ', ex)
      };
    

      try {
        let argid = 'beae-0cbi8av2block-add-to-cart',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-0cbi8av2',
        ...
        args.els = document.querySelectorAll('.beae-0cbi8av2');
        args.el = args.els[0];
        ((_) => { if(_.mode.value=="builder"){if(!_.els)return;for(let C=0;C<_.els.length;C++)if(C==_.loopIndex){const S=_.els[C].closest("form.beae-product-form-next");if(!S)return;const $=S.querySelector(".beae-add-to-cart--submit"),B=S.getAttribute("data-product_id"),k=S.querySelector('script[data-id="Product-json-'+B+'"]')||S.querySelector("#Product-json-"+B),M=JSON.parse(k!=null&&k.innerHTML?k==null?void 0:k.innerHTML:"{}").variants||[];let L=S.getAttribute("data-variant-id"),V=M[0];L&&(V=M.find(N=>N.id==L));const T=$.querySelector(".beae-add-to-cart-text-content");V!=null&&V.available?T&&(M.length>1?T.innerHTML=$.getAttribute("data-choose-options-text"):T.innerHTML=$.getAttribute("data-add-to-cart-text")):T&&(T.innerHTML=$.getAttribute("data-sold-out-text"))}} })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-0cbi8av2: ', ex)
      };
    

      try {
        let argid = 'beae-bu4h7e00block-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-bu4h7e00',
        ...
        args.els = document.querySelectorAll('.beae-bu4h7e00');
        args.el = args.els[0];
        ((P) => { P.el.querySelectorAll(".beae-x-text a").forEach(I=>{let z=I==null?void 0:I.getAttribute("href");I&&P.mode.value!=="builder"&&(z!=null&&z.includes("#"))&&I.addEventListener("click",O=>{let A=document.querySelector(z+","+(z==null?void 0:z.replace("#",".")));if(A)return A.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),O.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-bu4h7e00: ', ex)
      };
    

      try {
        let argid = 'beae-ufkkisooblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-ufkkisoo',
        ...
        args.els = document.querySelectorAll('.beae-ufkkisoo');
        args.el = args.els[0];
        ((P) => { P.el.querySelectorAll(".beae-x-text a").forEach(I=>{let z=I==null?void 0:I.getAttribute("href");I&&P.mode.value!=="builder"&&(z!=null&&z.includes("#"))&&I.addEventListener("click",O=>{let A=document.querySelector(z+","+(z==null?void 0:z.replace("#",".")));if(A)return A.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),O.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-ufkkisoo: ', ex)
      };
    }; if (window.BEAEBASE) {js_36M3503J()} else {window.BEAEPAGEJS.push(js_36M3503J)} })(); 